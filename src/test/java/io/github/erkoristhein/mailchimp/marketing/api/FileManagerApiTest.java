...
class FileManagerApiTest {
     ...
     */
    @Test
    void deleteFileManagerFilesIdTest() {
        String fileId = null;
     ...
     */
    @Test
    void deleteFileManagerFoldersIdTest() {
     ...
     */
    @Test
    void getFileManagerFilesIdTest() {
        String fileId = null;
        List<String> fields = null;
        List<String> excludeFields = null;
     ...
     */
    @Test
    void getFileManagerFoldersTest() {
        List<String> fields = null;
        List<String> excludeFields = null;
        Integer count = null;
        Integer offset = null;
     ...
     */
    @Test
    void getFileManagerFoldersFilesTest() {
        String folderId = null;
        List<String> fields = null;
        List<String> excludeFields = null;
        Integer count = null;
        ...
        FileManager response = api.getFileManagerFoldersFiles(folderId, fields, excludeFields, count, offset, type, createdBy, beforeCreatedAt, sinceCreatedAt, sortField, sortDir);
     ...
     */
    @Test
    void getFileManagerFoldersIdTest() {
        String folderId = null;
        List<String> fields = null;
        List<String> excludeFields = null;
     ...
     */
    @Test
    void patchFileManagerFilesIdTest() {
        String fileId = null;
     ...
     */
    @Test
    void patchFileManagerFoldersIdTest() {
        String folderId = null;
     ...
     */
    @Test
    void postFileManagerFoldersTest() {
        GalleryFolder1 body = null;
