...
class CampaignsApiTest {
    ...
    void getCampaignsIdTest() {
        ...
        List<String> excludeFields = null;
        Boolean includeResendShortcutEligibility = null;
        Boolean includeResendShortcutUsage = null;

        Campaign response = api.getCampaignsId(campaignId, fields, excludeFields, includeResendShortcutEligibility, includeResendShortcutUsage);
