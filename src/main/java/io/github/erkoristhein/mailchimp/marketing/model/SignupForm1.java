...
public class SignupForm1 {
  ...
  public SignupForm1 header(@jakarta.annotation.Nullable SignupFormHeaderOptions header) {
  ...
  public SignupForm1 contents(@jakarta.annotation.Nullable List<CollectionOfContentForListSignupForms> contents) {
  ...
  public SignupForm1 styles(@jakarta.annotation.Nullable List<CollectionOfElementStyleForListSignupForms> styles) {
