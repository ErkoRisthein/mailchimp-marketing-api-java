...
public class ConnectedSite2 {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_SITE_FOREIGN_ID, required = false)
  ...
  public ConnectedSite2 siteScript(@jakarta.annotation.Nullable Script1 siteScript) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_SITE_SCRIPT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_SITE_SCRIPT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSiteScript(@jakarta.annotation.Nullable Script1 siteScript) {
    this.siteScript = siteScript;
  }
