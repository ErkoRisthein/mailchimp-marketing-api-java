...
public class Unsubscribes {
  ...
  public Unsubscribes unsubscribes(List<Unsubscribes> unsubscribes) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_UNSUBSCRIBES)
  ...
  @JsonProperty(JSON_PROPERTY_UNSUBSCRIBES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setUnsubscribes(List<Unsubscribes> unsubscribes) {
    this.unsubscribes = unsubscribes;
  }
