...
public class GetReportingSurveysIdQuestionsIdAnswers200Response {
  ...
  public GetReportingSurveysIdQuestionsIdAnswers200Response answers(@jakarta.annotation.Nullable List<SurveyQuestionAnswer> answers) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ANSWERS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAnswers(@jakarta.annotation.Nullable List<SurveyQuestionAnswer> answers) {
    this.answers = answers;
  }
