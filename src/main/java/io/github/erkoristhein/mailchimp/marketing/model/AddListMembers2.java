...
public class AddListMembers2 {
  ...
  public AddListMembers2 emailAddress(@jakarta.annotation.Nonnull String emailAddress) {
  ...
  public AddListMembers2 statusIfNew(@jakarta.annotation.Nonnull StatusIfNewEnum statusIfNew) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_STATUS_IF_NEW, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(value = JSON_PROPERTY_STATUS_IF_NEW, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setStatusIfNew(@jakarta.annotation.Nonnull StatusIfNewEnum statusIfNew) {
    this.statusIfNew = statusIfNew;
  }

  public AddListMembers2 emailType(@jakarta.annotation.Nullable String emailType) {
  ...
  public AddListMembers2 status(@jakarta.annotation.Nullable StatusEnum status) {
  ...
  public AddListMembers2 mergeFields(@jakarta.annotation.Nullable Map<String, Object> mergeFields) {
  ...
  public AddListMembers2 interests(@jakarta.annotation.Nullable Map<String, Boolean> interests) {
  ...
  public AddListMembers2 language(@jakarta.annotation.Nullable String language) {
  ...
  public AddListMembers2 vip(@jakarta.annotation.Nullable Boolean vip) {
  ...
  public AddListMembers2 location(@jakarta.annotation.Nullable Location location) {
  ...
  public AddListMembers2 marketingPermissions(@jakarta.annotation.Nullable List<MarketingPermission1> marketingPermissions) {
  ...
  public AddListMembers2 ipSignup(@jakarta.annotation.Nullable String ipSignup) {
  ...
  public AddListMembers2 timestampSignup(@jakarta.annotation.Nullable OffsetDateTime timestampSignup) {
  ...
  public AddListMembers2 ipOpt(@jakarta.annotation.Nullable String ipOpt) {
  ...
  public AddListMembers2 timestampOpt(@jakarta.annotation.Nullable OffsetDateTime timestampOpt) {
