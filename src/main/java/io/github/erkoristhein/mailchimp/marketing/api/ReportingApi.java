...
public class ReportingApi extends BaseApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public SurveyReport getReportingSurveysId(String surveyId, List<String> fields, List<String> excludeFields) throws RestClientException {
        return getReportingSurveysIdWithHttpInfo(surveyId, fields, excludeFields).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<SurveyReport> getReportingSurveysIdWithHttpInfo(String surveyId, List<String> fields, List<String> excludeFields) throws RestClientException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'surveyId' is set
        if (surveyId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'surveyId' when calling getReportingSurveysId");
        }
        ...
        return apiClient.invokeAPI("/reporting/surveys/{survey_id}", HttpMethod.GET, uriVariables, localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
    /**
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public GetReportingSurveysIdQuestions200Response getReportingSurveysIdQuestions(String surveyId, List<String> fields, List<String> excludeFields) throws RestClientException {
        return getReportingSurveysIdQuestionsWithHttpInfo(surveyId, fields, excludeFields).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<GetReportingSurveysIdQuestions200Response> getReportingSurveysIdQuestionsWithHttpInfo(String surveyId, List<String> fields, List<String> excludeFields) throws RestClientException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'surveyId' is set
        if (surveyId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'surveyId' when calling getReportingSurveysIdQuestions");
        }
        ...
        return apiClient.invokeAPI("/reporting/surveys/{survey_id}/questions", HttpMethod.GET, uriVariables, localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
    /**
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public SurveyQuestionReport getReportingSurveysIdQuestionsId(String surveyId, String questionId, List<String> fields, List<String> excludeFields) throws RestClientException {
        return getReportingSurveysIdQuestionsIdWithHttpInfo(surveyId, questionId, fields, excludeFields).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<SurveyQuestionReport> getReportingSurveysIdQuestionsIdWithHttpInfo(String surveyId, String questionId, List<String> fields, List<String> excludeFields) throws RestClientException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'surveyId' is set
        if (surveyId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'surveyId' when calling getReportingSurveysIdQuestionsId");
        }
        ...
        return apiClient.invokeAPI("/reporting/surveys/{survey_id}/questions/{question_id}", HttpMethod.GET, uriVariables, localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
    /**
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public GetReportingSurveysIdQuestionsIdAnswers200Response getReportingSurveysIdQuestionsIdAnswers(String surveyId, String questionId, List<String> fields, List<String> excludeFields, String respondentFamiliarityIs) throws RestClientException {
        return getReportingSurveysIdQuestionsIdAnswersWithHttpInfo(surveyId, questionId, fields, excludeFields, respondentFamiliarityIs).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<GetReportingSurveysIdQuestionsIdAnswers200Response> getReportingSurveysIdQuestionsIdAnswersWithHttpInfo(String surveyId, String questionId, List<String> fields, List<String> excludeFields, String respondentFamiliarityIs) throws RestClientException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'surveyId' is set
        if (surveyId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'surveyId' when calling getReportingSurveysIdQuestionsIdAnswers");
        }
        ...
        return apiClient.invokeAPI("/reporting/surveys/{survey_id}/questions/{question_id}/answers", HttpMethod.GET, uriVariables, localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
    /**
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public GetReportingSurveysIdResponses200Response getReportingSurveysIdResponses(String surveyId, List<String> fields, List<String> excludeFields, Integer answeredQuestion, String choseAnswer, String respondentFamiliarityIs) throws RestClientException {
        return getReportingSurveysIdResponsesWithHttpInfo(surveyId, fields, excludeFields, answeredQuestion, choseAnswer, respondentFamiliarityIs).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<GetReportingSurveysIdResponses200Response> getReportingSurveysIdResponsesWithHttpInfo(String surveyId, List<String> fields, List<String> excludeFields, Integer answeredQuestion, String choseAnswer, String respondentFamiliarityIs) throws RestClientException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'surveyId' is set
        if (surveyId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'surveyId' when calling getReportingSurveysIdResponses");
        }
        ...
        return apiClient.invokeAPI("/reporting/surveys/{survey_id}/responses", HttpMethod.GET, uriVariables, localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
    /**
     * Get survey response
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public SurveyResponse getReportingSurveysIdResponsesId(String surveyId, String responseId) throws RestClientException {
        return getReportingSurveysIdResponsesIdWithHttpInfo(surveyId, responseId).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<SurveyResponse> getReportingSurveysIdResponsesIdWithHttpInfo(String surveyId, String responseId) throws RestClientException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'surveyId' is set
        if (surveyId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'surveyId' when calling getReportingSurveysIdResponsesId");
        }
        ...
        return apiClient.invokeAPI("/reporting/surveys/{survey_id}/responses/{response_id}", HttpMethod.GET, uriVariables, localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
