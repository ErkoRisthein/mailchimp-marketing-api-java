...
public class GetReportsIdEcommerceProductActivity200Response {
  ...
  private List<GetReportsIdEcommerceProductActivity200ResponseProductsInner> products = new ArrayList<>();
  ...
  public GetReportsIdEcommerceProductActivity200Response products(@jakarta.annotation.Nullable List<GetReportsIdEcommerceProductActivity200ResponseProductsInner> products) {
  ...
  @JsonProperty(value = JSON_PROPERTY_PRODUCTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setProducts(@jakarta.annotation.Nullable List<GetReportsIdEcommerceProductActivity200ResponseProductsInner> products) {
    this.products = products;
  }
