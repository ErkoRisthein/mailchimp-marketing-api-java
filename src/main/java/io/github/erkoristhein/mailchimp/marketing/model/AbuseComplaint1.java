 ...
 */
@JsonPropertyOrder({
  AbuseComplaint1.JSON_PROPERTY_ID,
  AbuseComplaint1.JSON_PROPERTY_CAMPAIGN_ID,
  AbuseComplaint1.JSON_PROPERTY_LIST_ID,
  AbuseComplaint1.JSON_PROPERTY_LIST_IS_ACTIVE,
  AbuseComplaint1.JSON_PROPERTY_EMAIL_ID,
  AbuseComplaint1.JSON_PROPERTY_EMAIL_ADDRESS,
  AbuseComplaint1.JSON_PROPERTY_MERGE_FIELDS,
  AbuseComplaint1.JSON_PROPERTY_VIP,
  AbuseComplaint1.JSON_PROPERTY_DATE,
  AbuseComplaint1.JSON_PROPERTY_LINKS
})
@JsonTypeName("Abuse_Complaint_1")
...
public class AbuseComplaint1 {
  ...
  public AbuseComplaint1 mergeFields(@jakarta.annotation.Nullable Map<String, Object> mergeFields) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, abuseComplaint1.id) &&
        ...
        Objects.equals(this.links, abuseComplaint1.links);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, campaignId, listId, listIsActive, emailId, emailAddress, mergeFields, vip, date, links);
  }
