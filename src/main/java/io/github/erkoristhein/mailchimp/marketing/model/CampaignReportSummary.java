 ...
 */
@JsonPropertyOrder({
  CampaignReportSummary.JSON_PROPERTY_OPENS,
  CampaignReportSummary.JSON_PROPERTY_UNIQUE_OPENS,
  CampaignReportSummary.JSON_PROPERTY_OPEN_RATE,
  CampaignReportSummary.JSON_PROPERTY_CLICKS,
  CampaignReportSummary.JSON_PROPERTY_SUBSCRIBER_CLICKS,
  CampaignReportSummary.JSON_PROPERTY_CLICK_RATE
})
@JsonTypeName("Campaign_Report_Summary")
