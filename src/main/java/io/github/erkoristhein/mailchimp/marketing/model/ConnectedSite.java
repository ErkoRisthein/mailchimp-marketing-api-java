...
public class ConnectedSite {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_FOREIGN_ID, required = false)
  ...
  public ConnectedSite siteScript(@jakarta.annotation.Nullable Script siteScript) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SITE_SCRIPT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSiteScript(@jakarta.annotation.Nullable Script siteScript) {
    this.siteScript = siteScript;
  }
