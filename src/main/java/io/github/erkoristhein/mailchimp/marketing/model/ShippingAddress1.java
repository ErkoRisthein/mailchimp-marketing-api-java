...
public class ShippingAddress1 {
  ...
  public ShippingAddress1 name(@jakarta.annotation.Nullable String name) {
  ...
  public ShippingAddress1 address1(@jakarta.annotation.Nullable String address1) {
  ...
  public ShippingAddress1 address2(@jakarta.annotation.Nullable String address2) {
  ...
  public ShippingAddress1 city(@jakarta.annotation.Nullable String city) {
  ...
  public ShippingAddress1 province(@jakarta.annotation.Nullable String province) {
  ...
  public ShippingAddress1 provinceCode(@jakarta.annotation.Nullable String provinceCode) {
  ...
  public ShippingAddress1 postalCode(@jakarta.annotation.Nullable String postalCode) {
  ...
  public ShippingAddress1 country(@jakarta.annotation.Nullable String country) {
  ...
  public ShippingAddress1 countryCode(@jakarta.annotation.Nullable String countryCode) {
  ...
  public ShippingAddress1 longitude(@jakarta.annotation.Nullable BigDecimal longitude) {
  ...
  public ShippingAddress1 latitude(@jakarta.annotation.Nullable BigDecimal latitude) {
  ...
  public ShippingAddress1 phone(@jakarta.annotation.Nullable String phone) {
  ...
  public ShippingAddress1 company(@jakarta.annotation.Nullable String company) {
