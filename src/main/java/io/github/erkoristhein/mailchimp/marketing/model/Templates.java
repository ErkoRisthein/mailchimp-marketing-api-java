...
public class Templates {
  ...
  public Templates templates(@jakarta.annotation.Nullable List<TemplateInstance> templates) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TEMPLATES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTemplates(@jakarta.annotation.Nullable List<TemplateInstance> templates) {
    this.templates = templates;
  }
