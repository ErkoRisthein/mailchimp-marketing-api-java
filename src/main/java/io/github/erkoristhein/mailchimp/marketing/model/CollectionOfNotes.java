...
public class CollectionOfNotes {
  ...
  private List<MemberNotes> notes = new ArrayList<>();
  ...
  public CollectionOfNotes notes(@jakarta.annotation.Nullable List<MemberNotes> notes) {
  ...
  @JsonProperty(value = JSON_PROPERTY_NOTES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNotes(@jakarta.annotation.Nullable List<MemberNotes> notes) {
    this.notes = notes;
  }
