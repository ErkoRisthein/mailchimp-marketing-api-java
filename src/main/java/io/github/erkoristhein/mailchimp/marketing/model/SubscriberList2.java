...
public class SubscriberList2 {
  ...
  public SubscriberList2 name(@jakarta.annotation.Nonnull String name) {
  ...
  public SubscriberList2 contact(@jakarta.annotation.Nonnull ListContact2 contact) {
  ...
  @JsonProperty(value = JSON_PROPERTY_CONTACT, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setContact(@jakarta.annotation.Nonnull ListContact2 contact) {
    this.contact = contact;
  }

  public SubscriberList2 permissionReminder(@jakarta.annotation.Nonnull String permissionReminder) {
  ...
  public SubscriberList2 useArchiveBar(@jakarta.annotation.Nullable Boolean useArchiveBar) {
  ...
  public SubscriberList2 campaignDefaults(@jakarta.annotation.Nonnull CampaignDefaults1 campaignDefaults) {
  ...
  public SubscriberList2 notifyOnSubscribe(@jakarta.annotation.Nullable String notifyOnSubscribe) {
  ...
  public SubscriberList2 notifyOnUnsubscribe(@jakarta.annotation.Nullable String notifyOnUnsubscribe) {
  ...
  public SubscriberList2 emailTypeOption(@jakarta.annotation.Nonnull Boolean emailTypeOption) {
  ...
  public SubscriberList2 doubleOptin(@jakarta.annotation.Nullable Boolean doubleOptin) {
  ...
  public SubscriberList2 marketingPermissions(@jakarta.annotation.Nullable Boolean marketingPermissions) {
