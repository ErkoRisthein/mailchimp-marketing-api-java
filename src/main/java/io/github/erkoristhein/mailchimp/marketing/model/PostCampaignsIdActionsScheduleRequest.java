...
public class PostCampaignsIdActionsScheduleRequest {
  ...
  public PostCampaignsIdActionsScheduleRequest scheduleTime(@jakarta.annotation.Nonnull OffsetDateTime scheduleTime) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_SCHEDULE_TIME, required = true)
  ...
  @JsonProperty(value = JSON_PROPERTY_SCHEDULE_TIME, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setScheduleTime(@jakarta.annotation.Nonnull OffsetDateTime scheduleTime) {
    this.scheduleTime = scheduleTime;
  }

  public PostCampaignsIdActionsScheduleRequest timewarp(@jakarta.annotation.Nullable Boolean timewarp) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TIMEWARP, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTimewarp(@jakarta.annotation.Nullable Boolean timewarp) {
    this.timewarp = timewarp;
  }

  public PostCampaignsIdActionsScheduleRequest batchDelivery(@jakarta.annotation.Nullable BatchDelivery batchDelivery) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_BATCH_DELIVERY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_BATCH_DELIVERY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBatchDelivery(@jakarta.annotation.Nullable BatchDelivery batchDelivery) {
    this.batchDelivery = batchDelivery;
  }
