...
public class Carts {
  ...
  @jakarta.annotation.Nullable
  private List<ECommerceCart> carts = new ArrayList<>();
  ...
  public Carts storeId(@jakarta.annotation.Nullable String storeId) {
  ...
  public Carts carts(@jakarta.annotation.Nullable List<ECommerceCart> carts) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CARTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_CARTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCarts(@jakarta.annotation.Nullable List<ECommerceCart> carts) {
    this.carts = carts;
  }
