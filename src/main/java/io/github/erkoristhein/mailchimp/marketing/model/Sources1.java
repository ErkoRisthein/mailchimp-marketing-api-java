...
public class Sources1 {
  ...
  public Sources1 user(@jakarta.annotation.Nullable Boolean user) {
  ...
  public Sources1 admin(@jakarta.annotation.Nullable Boolean admin) {
  ...
  public Sources1 api(@jakarta.annotation.Nullable Boolean api) {
