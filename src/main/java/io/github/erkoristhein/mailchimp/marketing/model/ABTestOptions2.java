 ...
 */
@JsonPropertyOrder({
  ABTestOptions2.JSON_PROPERTY_WINNING_COMBINATION_ID,
  ABTestOptions2.JSON_PROPERTY_WINNING_CAMPAIGN_ID,
  ABTestOptions2.JSON_PROPERTY_WINNER_CRITERIA,
  ABTestOptions2.JSON_PROPERTY_WAIT_TIME,
  ABTestOptions2.JSON_PROPERTY_TEST_SIZE,
  ABTestOptions2.JSON_PROPERTY_SUBJECT_LINES,
  ABTestOptions2.JSON_PROPERTY_SEND_TIMES,
  ABTestOptions2.JSON_PROPERTY_FROM_NAMES,
  ABTestOptions2.JSON_PROPERTY_REPLY_TO_ADDRESSES,
  ABTestOptions2.JSON_PROPERTY_CONTENTS,
  ABTestOptions2.JSON_PROPERTY_COMBINATIONS
})
@JsonTypeName("A_B_Test_Options_2")
...
public class ABTestOptions2 {
  ...
  public ABTestOptions2 winnerCriteria(@jakarta.annotation.Nonnull WinnerCriteriaEnum winnerCriteria) {
  ...
  public ABTestOptions2 waitTime(@jakarta.annotation.Nullable Integer waitTime) {
  ...
  public ABTestOptions2 testSize(@jakarta.annotation.Nullable Integer testSize) {
  ...
  public ABTestOptions2 subjectLines(@jakarta.annotation.Nullable List<String> subjectLines) {
  ...
  public ABTestOptions2 sendTimes(@jakarta.annotation.Nullable List<OffsetDateTime> sendTimes) {
    
    this.sendTimes = sendTimes;
    return this;
  }

  public ABTestOptions2 addSendTimesItem(OffsetDateTime sendTimesItem) {
  ...
  public ABTestOptions2 fromNames(@jakarta.annotation.Nullable List<String> fromNames) {
  ...
  public ABTestOptions2 replyToAddresses(@jakarta.annotation.Nullable List<String> replyToAddresses) {
