...
public class BillingAddress1 {
  ...
  public BillingAddress1 name(@jakarta.annotation.Nullable String name) {
  ...
  public BillingAddress1 address1(@jakarta.annotation.Nullable String address1) {
  ...
  public BillingAddress1 address2(@jakarta.annotation.Nullable String address2) {
  ...
  public BillingAddress1 city(@jakarta.annotation.Nullable String city) {
  ...
  public BillingAddress1 province(@jakarta.annotation.Nullable String province) {
  ...
  public BillingAddress1 provinceCode(@jakarta.annotation.Nullable String provinceCode) {
  ...
  public BillingAddress1 postalCode(@jakarta.annotation.Nullable String postalCode) {
  ...
  public BillingAddress1 country(@jakarta.annotation.Nullable String country) {
  ...
  public BillingAddress1 countryCode(@jakarta.annotation.Nullable String countryCode) {
  ...
  public BillingAddress1 longitude(@jakarta.annotation.Nullable BigDecimal longitude) {
  ...
  public BillingAddress1 latitude(@jakarta.annotation.Nullable BigDecimal latitude) {
  ...
  public BillingAddress1 phone(@jakarta.annotation.Nullable String phone) {
  ...
  public BillingAddress1 company(@jakarta.annotation.Nullable String company) {
