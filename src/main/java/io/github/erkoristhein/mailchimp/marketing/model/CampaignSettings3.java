...
public class CampaignSettings3 {
  ...
  public CampaignSettings3 subjectLine(@jakarta.annotation.Nullable String subjectLine) {
  ...
  public CampaignSettings3 previewText(@jakarta.annotation.Nullable String previewText) {
  ...
  public CampaignSettings3 title(@jakarta.annotation.Nullable String title) {
  ...
  public CampaignSettings3 fromName(@jakarta.annotation.Nullable String fromName) {
  ...
  public CampaignSettings3 replyTo(@jakarta.annotation.Nullable String replyTo) {
  ...
  public CampaignSettings3 useConversation(@jakarta.annotation.Nullable Boolean useConversation) {
  ...
  public CampaignSettings3 toName(@jakarta.annotation.Nullable String toName) {
  ...
  public CampaignSettings3 folderId(@jakarta.annotation.Nullable String folderId) {
  ...
  public CampaignSettings3 authenticate(@jakarta.annotation.Nullable Boolean authenticate) {
  ...
  public CampaignSettings3 autoFooter(@jakarta.annotation.Nullable Boolean autoFooter) {
  ...
  public CampaignSettings3 inlineCss(@jakarta.annotation.Nullable Boolean inlineCss) {
  ...
  public CampaignSettings3 autoTweet(@jakarta.annotation.Nullable Boolean autoTweet) {
  ...
  public CampaignSettings3 autoFbPost(@jakarta.annotation.Nullable List<String> autoFbPost) {
  ...
  public CampaignSettings3 fbComments(@jakarta.annotation.Nullable Boolean fbComments) {
  ...
  public CampaignSettings3 templateId(@jakarta.annotation.Nullable Integer templateId) {
