...
public class TwitterStats {
  ...
  @jakarta.annotation.Nullable
  private List<TwitterStatus> statuses = new ArrayList<>();
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_FIRST_TWEET, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_LAST_TWEET, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_RETWEETS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
