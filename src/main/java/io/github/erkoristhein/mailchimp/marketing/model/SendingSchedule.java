...
public class SendingSchedule {
  ...
  public SendingSchedule hour(@jakarta.annotation.Nullable Integer hour) {
  ...
  public SendingSchedule dailySend(@jakarta.annotation.Nullable DailySendingDays dailySend) {
  ...
  public SendingSchedule weeklySendDay(@jakarta.annotation.Nullable WeeklySendDayEnum weeklySendDay) {
  ...
  public SendingSchedule monthlySendDate(@jakarta.annotation.Nullable BigDecimal monthlySendDate) {
