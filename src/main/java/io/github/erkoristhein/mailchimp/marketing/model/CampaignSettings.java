...
public class CampaignSettings {
  ...
  public CampaignSettings subjectLine(@jakarta.annotation.Nullable String subjectLine) {
  ...
  public CampaignSettings previewText(@jakarta.annotation.Nullable String previewText) {
  ...
  public CampaignSettings title(@jakarta.annotation.Nullable String title) {
  ...
  public CampaignSettings fromName(@jakarta.annotation.Nullable String fromName) {
  ...
  public CampaignSettings replyTo(@jakarta.annotation.Nullable String replyTo) {
  ...
  public CampaignSettings authenticate(@jakarta.annotation.Nullable Boolean authenticate) {
  ...
  public CampaignSettings autoFooter(@jakarta.annotation.Nullable Boolean autoFooter) {
  ...
  public CampaignSettings inlineCss(@jakarta.annotation.Nullable Boolean inlineCss) {
  ...
  public CampaignSettings autoTweet(@jakarta.annotation.Nullable Boolean autoTweet) {
  ...
  public CampaignSettings autoFbPost(@jakarta.annotation.Nullable List<String> autoFbPost) {
  ...
  public CampaignSettings fbComments(@jakarta.annotation.Nullable Boolean fbComments) {
  ...
  public CampaignSettings templateId(@jakarta.annotation.Nullable Integer templateId) {
