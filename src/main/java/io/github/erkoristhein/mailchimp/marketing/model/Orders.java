...
@JsonPropertyOrder({
  ...
  Orders.JSON_PROPERTY_TOTAL_ITEMS,
  Orders.JSON_PROPERTY_LINKS
})
...
public class Orders {
  ...
  public Orders orders(@jakarta.annotation.Nullable List<ECommerceOrder> orders) {
    
    this.orders = orders;
    return this;
  }

  public Orders addOrdersItem(ECommerceOrder ordersItem) {
    if (this.orders == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.orders, orders.orders) &&
        ...
        Objects.equals(this.links, orders.links);
  }

  @Override
  public int hashCode() {
    return Objects.hash(orders, totalItems, links);
  }
