...
public class GalleryFile {
  ...
  public GalleryFile folderId(@jakarta.annotation.Nullable Integer folderId) {
  ...
  public GalleryFile name(@jakarta.annotation.Nullable String name) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_FULL_SIZE_URL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
