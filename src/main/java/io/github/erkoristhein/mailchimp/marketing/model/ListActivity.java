...
public class ListActivity {
  ...
  public ListActivity activity(@jakarta.annotation.Nullable List<DailyListActivity> activity) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ACTIVITY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setActivity(@jakarta.annotation.Nullable List<DailyListActivity> activity) {
    this.activity = activity;
  }

  public ListActivity listId(@jakarta.annotation.Nullable String listId) {
