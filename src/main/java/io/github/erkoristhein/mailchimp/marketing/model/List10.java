 ...
 */
@JsonPropertyOrder({
  List10.JSON_PROPERTY_LIST_ID,
  List10.JSON_PROPERTY_LIST_IS_ACTIVE,
  List10.JSON_PROPERTY_LIST_NAME,
  List10.JSON_PROPERTY_SEGMENT_TEXT,
  List10.JSON_PROPERTY_RECIPIENT_COUNT,
  List10.JSON_PROPERTY_SEGMENT_OPTS
})
@JsonTypeName("List_10")
