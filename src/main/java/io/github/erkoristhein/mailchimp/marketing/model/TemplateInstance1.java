...
public class TemplateInstance1 {
  ...
  public TemplateInstance1 name(@jakarta.annotation.Nonnull String name) {
  ...
  public TemplateInstance1 folderId(@jakarta.annotation.Nullable String folderId) {
  ...
  public TemplateInstance1 html(@jakarta.annotation.Nonnull String html) {
