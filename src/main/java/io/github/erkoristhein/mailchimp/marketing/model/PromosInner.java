...
public class PromosInner {
  ...
  public PromosInner code(@jakarta.annotation.Nullable String code) {
  ...
  public PromosInner amountDiscounted(@jakarta.annotation.Nullable BigDecimal amountDiscounted) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_AMOUNT_DISCOUNTED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_AMOUNT_DISCOUNTED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAmountDiscounted(@jakarta.annotation.Nullable BigDecimal amountDiscounted) {
    this.amountDiscounted = amountDiscounted;
  }

  public PromosInner type(@jakarta.annotation.Nullable TypeEnum type) {
