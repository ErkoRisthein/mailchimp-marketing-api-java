 ...
 */
@JsonPropertyOrder({
  Address2.JSON_PROPERTY_ADDRESS1,
  Address2.JSON_PROPERTY_ADDRESS2,
  Address2.JSON_PROPERTY_CITY,
  Address2.JSON_PROPERTY_PROVINCE,
  Address2.JSON_PROPERTY_PROVINCE_CODE,
  Address2.JSON_PROPERTY_POSTAL_CODE,
  Address2.JSON_PROPERTY_COUNTRY,
  Address2.JSON_PROPERTY_COUNTRY_CODE
})
@JsonTypeName("Address_2")
...
public class Address2 {
  ...
  public Address2 address1(@jakarta.annotation.Nullable String address1) {
  ...
  public Address2 address2(@jakarta.annotation.Nullable String address2) {
  ...
  public Address2 city(@jakarta.annotation.Nullable String city) {
  ...
  public Address2 province(@jakarta.annotation.Nullable String province) {
  ...
  public Address2 provinceCode(@jakarta.annotation.Nullable String provinceCode) {
  ...
  public Address2 postalCode(@jakarta.annotation.Nullable String postalCode) {
  ...
  public Address2 country(@jakarta.annotation.Nullable String country) {
  ...
  public Address2 countryCode(@jakarta.annotation.Nullable String countryCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address1, address2.address1) &&
        ...
        Objects.equals(this.province, address2.province) &&
        Objects.equals(this.provinceCode, address2.provinceCode) &&
