...
public class Products {
  ...
  @jakarta.annotation.Nullable
  private List<ECommerceProduct2> products = new ArrayList<>();
  ...
  public Products storeId(@jakarta.annotation.Nullable String storeId) {
  ...
  public Products products(@jakarta.annotation.Nullable List<ECommerceProduct2> products) {
    
    this.products = products;
    return this;
  }

  public Products addProductsItem(ECommerceProduct2 productsItem) {
  ...
  public List<ECommerceProduct2> getProducts() {
    return products;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PRODUCTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setProducts(@jakarta.annotation.Nullable List<ECommerceProduct2> products) {
    this.products = products;
  }
