 ...
 */
@JsonPropertyOrder({
  EmailActivity1.JSON_PROPERTY_CAMPAIGN_ID,
  EmailActivity1.JSON_PROPERTY_LIST_ID,
  EmailActivity1.JSON_PROPERTY_LIST_IS_ACTIVE,
  EmailActivity1.JSON_PROPERTY_EMAIL_ID,
  EmailActivity1.JSON_PROPERTY_EMAIL_ADDRESS,
  EmailActivity1.JSON_PROPERTY_ACTIVITY,
  EmailActivity1.JSON_PROPERTY_LINKS
})
@JsonTypeName("Email_Activity_1")
...
public class EmailActivity1 {
  ...
  public EmailActivity1 activity(@jakarta.annotation.Nullable List<MemberActivity2> activity) {
    
    this.activity = activity;
    return this;
  }

  public EmailActivity1 addActivityItem(MemberActivity2 activityItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.campaignId, emailActivity1.campaignId) &&
        ...
        Objects.equals(this.links, emailActivity1.links);
  }
