...
public class CampaignFeedback {
  ...
  public CampaignFeedback blockId(@jakarta.annotation.Nullable Integer blockId) {
  ...
  public CampaignFeedback message(@jakarta.annotation.Nonnull String message) {
  ...
  public CampaignFeedback isComplete(@jakarta.annotation.Nullable Boolean isComplete) {
