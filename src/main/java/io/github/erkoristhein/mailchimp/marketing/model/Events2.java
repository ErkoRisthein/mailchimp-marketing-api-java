...
public class Events2 {
  ...
  public Events2 subscribe(@jakarta.annotation.Nullable Boolean subscribe) {
  ...
  public Events2 unsubscribe(@jakarta.annotation.Nullable Boolean unsubscribe) {
  ...
  public Events2 profile(@jakarta.annotation.Nullable Boolean profile) {
  ...
  public Events2 cleaned(@jakarta.annotation.Nullable Boolean cleaned) {
  ...
  public Events2 upemail(@jakarta.annotation.Nullable Boolean upemail) {
  ...
  public Events2 campaign(@jakarta.annotation.Nullable Boolean campaign) {
