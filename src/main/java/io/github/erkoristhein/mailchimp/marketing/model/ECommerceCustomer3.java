...
@JsonPropertyOrder({
  ...
  ECommerceCustomer3.JSON_PROPERTY_SMS_PHONE_NUMBER,
...
public class ECommerceCustomer3 {
  ...
  public ECommerceCustomer3 id(@jakarta.annotation.Nonnull String id) {
  ...
  public ECommerceCustomer3 emailAddress(@jakarta.annotation.Nullable String emailAddress) {
  ...
  public ECommerceCustomer3 smsPhoneNumber(@jakarta.annotation.Nullable String smsPhoneNumber) {
  ...
  public ECommerceCustomer3 optInStatus(@jakarta.annotation.Nonnull Boolean optInStatus) {
  ...
  public ECommerceCustomer3 company(@jakarta.annotation.Nullable String company) {
  ...
  public ECommerceCustomer3 firstName(@jakarta.annotation.Nullable String firstName) {
  ...
  public ECommerceCustomer3 lastName(@jakarta.annotation.Nullable String lastName) {
  ...
  public ECommerceCustomer3 address(@jakarta.annotation.Nullable Address address) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, eCommerceCustomer3.id) &&
        ...
        Objects.equals(this.smsPhoneNumber, eCommerceCustomer3.smsPhoneNumber) &&
