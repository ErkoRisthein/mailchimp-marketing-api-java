...
> Campaign3 postListsIdSurveysIdActionsCreateEmail(listId, surveyId)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            Campaign3 result = apiInstance.postListsIdSurveysIdActionsCreateEmail(listId, surveyId);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling SurveysApi#postListsIdSurveysIdActionsCreateEmail");
