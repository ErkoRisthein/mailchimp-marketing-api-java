...
|**variants** | [**List&lt;ECommerceProductVariant&gt;**](ECommerceProductVariant.md) | An array of the product&#39;s variants. At least one variant is required for each product. A variant can use the same &#x60;id&#x60; and &#x60;title&#x60; as the parent product. |  [optional] |
