...
- Build date: 2025-11-23T16:28:01.262813+02:00[Europe/Tallinn]
...
```bash
# To regenerate the code from scratch (recommended to avoid old leftover classes):
rm -rf src/main/java src/test/java

# Then run the generator (using custom templates to handle empty enum values):
openapi-generator generate \
  ...
  --api-package io.github.erkoristhein.mailchimp.marketing.api \
  --artifact-id mailchimp-marketing-api-java \
  --artifact-version 3.0.90-fix3 \
  --group-id io.github.erkoristhein.mailchimp.marketing \
  --invoker-package io.github.erkoristhein.mailchimp.marketing \
  --model-package io.github.erkoristhein.mailchimp.marketing.model \
  --additional-properties=useJakartaEe=true \
  --skip-validate-spec
```

**Important Notes:**
- The **pom.xml** includes custom repository configurations (repo1.maven.org and repo.maven.apache.org). After regenerating, you need to re-add the `<repositories>` section to the pom.xml, as it gets overwritten.
- The **.gitignore** may have custom changes. Review and restore any custom entries after regeneration if needed.
...
```groovy
  ...
  dependencies {
     implementation "io.github.erkoristhein.mailchimp.marketing:mailchimp-marketing-api-java:3.0.90-fix3"
  }
```
...
- `target/mailchimp-marketing-api-java-3.0.90-fix3.jar`
- `target/lib/*.jar`
...
*AudiencesApi* | [**createAudienceContact**](docs/AudiencesApi.md#createAudienceContact) | **POST** /audiences/{audience_id}/contacts | Add Contact
*AudiencesApi* | [**getAudienceContact**](docs/AudiencesApi.md#getAudienceContact) | **GET** /audiences/{audience_id}/contacts/{contact_id} | Get Contact
*AudiencesApi* | [**getAudienceContactList**](docs/AudiencesApi.md#getAudienceContactList) | **GET** /audiences/{audience_id}/contacts | Get Contacts
*AudiencesApi* | [**patchAudienceContact**](docs/AudiencesApi.md#patchAudienceContact) | **PATCH** /audiences/{audience_id}/contacts/{contact_id} | Update Contact
...
*ContactsApi* | [**createAudienceContact**](docs/ContactsApi.md#createAudienceContact) | **POST** /audiences/{audience_id}/contacts | Add Contact
*ContactsApi* | [**getAudienceContact**](docs/ContactsApi.md#getAudienceContact) | **GET** /audiences/{audience_id}/contacts/{contact_id} | Get Contact
*ContactsApi* | [**getAudienceContactList**](docs/ContactsApi.md#getAudienceContactList) | **GET** /audiences/{audience_id}/contacts | Get Contacts
*ContactsApi* | [**getAudienceContacts**](docs/ContactsApi.md#getAudienceContacts) | **GET** /audiences | Get a list of audiences
*ContactsApi* | [**getAudienceId**](docs/ContactsApi.md#getAudienceId) | **GET** /audiences/{audience_id} | Get audience info
*ContactsApi* | [**patchAudienceContact**](docs/ContactsApi.md#patchAudienceContact) | **PATCH** /audiences/{audience_id}/contacts/{contact_id} | Update Contact
*ContactsApi* | [**postAudiencesContactsActionsArchive**](docs/ContactsApi.md#postAudiencesContactsActionsArchive) | **POST** /audiences/{audience_id}/contacts/{contact_id}/actions/archive | Archive Contact
*ContactsApi* | [**postAudiencesContactsActionsForget**](docs/ContactsApi.md#postAudiencesContactsActionsForget) | **POST** /audiences/{audience_id}/contacts/{contact_id}/actions/forget | Forget Contact
...
*EcommerceApi* | [**putEcommerceStoresIdOrdersId**](docs/EcommerceApi.md#putEcommerceStoresIdOrdersId) | **PUT** /ecommerce/stores/{store_id}/orders/{order_id} | Add or update order
*EcommerceApi* | [**putEcommerceStoresIdProductsId**](docs/EcommerceApi.md#putEcommerceStoresIdProductsId) | **PUT** /ecommerce/stores/{store_id}/products/{product_id} | Create or update product
...
## Documentation for Models
 ...
 - [AudiencesInner](docs/AudiencesInner.md)
 ...
 - [BillingAddress2](docs/BillingAddress2.md)
 ...
 - [CreateAudienceContactRequest](docs/CreateAudienceContactRequest.md)
 ...
 - [ECommerceProduct3](docs/ECommerceProduct3.md)
 ...
 - [EmailChannelDetailsEffectiveSubscriptionStatus](docs/EmailChannelDetailsEffectiveSubscriptionStatus.md)
 - [EmailChannelDetailsMarketingConsent](docs/EmailChannelDetailsMarketingConsent.md)
 ...
 - [GetAudienceContactList200Response](docs/GetAudienceContactList200Response.md)
 - [GetAudienceContacts200Response](docs/GetAudienceContacts200Response.md)
 ...
 - [MarketingConsentDetails](docs/MarketingConsentDetails.md)
 - [MarketingConsentDetails1](docs/MarketingConsentDetails1.md)
 ...
 - [OriginalCampaign](docs/OriginalCampaign.md)
 - [Outreach](docs/Outreach.md)
 - [Outreach1](docs/Outreach1.md)
 - [PartialMatches](docs/PartialMatches.md)
 - [PatchAudienceContactRequest](docs/PatchAudienceContactRequest.md)
 ...
 - [ResendShortcutUsage](docs/ResendShortcutUsage.md)
 - [ResourceLink](docs/ResourceLink.md)
 - [Response](docs/Response.md)
 - [ResultsInner](docs/ResultsInner.md)
 - [SMSChannelDetails](docs/SMSChannelDetails.md)
 - [SMSChannelDetails1](docs/SMSChannelDetails1.md)
 - [SMSChannelDetails2](docs/SMSChannelDetails2.md)
 - [SMSChannelDetailsMarketingConsent](docs/SMSChannelDetailsMarketingConsent.md)
 ...
 - [ShippingAddress2](docs/ShippingAddress2.md)
 - [ShortcutCampaignsInner](docs/ShortcutCampaignsInner.md)
 ...
 - [SubscriberInAutomationFlowSAudience](docs/SubscriberInAutomationFlowSAudience.md)
 ...
 - [ToNonPurchasers](docs/ToNonPurchasers.md)
